...
qt_android_platform_plugin="$pyqt_prefix/plugins/platforms/libplugins_platforms_qtforandroid_${abi}.so"
...
test -f "$qt_android_platform_plugin"
...
qt_platform_plugins_dir="$output_dir/assets/qt/plugins/platforms"

mkdir -p "$jni_lib_dir" "$python_lib_dir" "$krita_python_libs_dir/PyKrita" "$qt_platform_plugins_dir"
...
cp -a "$qapplication_probe" "$krita_python_libs_dir/krita_probe_qapplication.py"
cp -a "$qapplication_import_probe" "$krita_python_libs_dir/krita_probe_qapplication_import.py"
cp -a "$qcoreapplication_probe" "$krita_python_libs_dir/krita_probe_qcoreapplication.py"
cp -a "$qcoreapplication_import_probe" "$krita_python_libs_dir/krita_probe_qcoreapplication_import.py"
cp -a "$krita_source_dir/plugins/extensions/pykrita/plugin/krita" "$krita_python_libs_dir/"
cp -a "$qt_android_platform_plugin" "$qt_platform_plugins_dir/"
...
test -f "$krita_python_libs_dir/krita_probe_qapplication.py"
test -f "$krita_python_libs_dir/krita_probe_qapplication_import.py"
test -f "$krita_python_libs_dir/krita_probe_qcoreapplication.py"
test -f "$krita_python_libs_dir/krita_probe_qcoreapplication_import.py"
test -f "$krita_python_libs_dir/krita/__init__.py"
test -f "$qt_platform_plugins_dir/libplugins_platforms_qtforandroid_${abi}.so"
...
check_machine "$qt_platform_plugins_dir/libplugins_platforms_qtforandroid_${abi}.so"
